...
const AppValuesScreen = ({ navigation }) => {
  ...
  const valuesDetails = {
    'الشمولية ':
      'نؤمن بأن لكل فرد الحق في بيئة عمل عادلة ومهيأة.',
    'الشفافية ':
      'نقدم تقييمات واضحة مبنية على معايير قابلة للقياس.',
    'التمكين ':
      'نساعد الأفراد على الوصول لفرص مناسبة، ونمكّن الجهات من التحسين.',
    'الابتكار ':
      'نستخدم التقنية لتقديم حلول ذكية تعالج تحديات حقيقية.',
    'الموثوقية ':
      'نحرص على دقة البيانات وجودة النتائج المقدمة.',
    'الاستدامة ':
      'نهدف إلى إحداث تأثير طويل المدى في بيئات العمل.',
  };
...
export default AppValuesScreen;
